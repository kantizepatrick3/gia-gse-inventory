...
const ReceivePart = ({ token, onReceiveComplete }) => {
  ...
  const handleReceive = async (e) => {
    ...
    try {
      ...
      if (formData.update_price && formData.unit_price) {
      ...
      setMessage(`✓ Part "${formData.part_number}" received successfully${priceMsg}!`);
      setFormData({ 
        part_number: '', 
        quantity: '', 
        reference_number: '', 
              ...
              {formData.update_price && (
                <div style={{ marginTop: '10px' }}>
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    required={formData.update_price}
                    style={{
                      width: '100%',
                      padding: '8px',
                      borderRadius: '4px',
                  ...
                  <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>
                    💡 This will update the part's current price and record it in price history.
                  </p>
                </div>
              )}
            </div>
          ...
          <form onSubmit={handleCreateAndReceive} style={{
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <input
                ...
                onChange={(e) => setNewPartData({...newPartData, unit_price: e.target.value})}
                placeholder="0.00"
                style={{
                  width: '100%',
                  padding: '8px',
              ...
              />
              <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>
                💡 Set the initial price for this part.
              </p>
            </div>
